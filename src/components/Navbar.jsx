...
function Navbar() {
  return (
    <div className="w-full fixed z-[999] top-0">
      <div className="  max-w-screen-2xl px-4 py-6 lg:py-10 lg:px-10 text-xl text-white flex items-center justify-between">
        <motion.div
          initial={{ opacity: 0 }}
        ...
        >
          <svg
            ...
            class="wordmark-icon"
            data-v-1932cced=""
            className="w-20 opacity: 1; visibility: inherit;"
          >
            <path
        ...
        <motion.div  initial={{ opacity: 0 }}
          ...
          viewport={{ once: true }}
          transition={{ ease: [Power4.easeInOut], duration: 1.5 }}
           className="links hidden sm:block">
          {["work", "studio", "news", "contact"].map((e, i) => {
            return (
              <a
                className="px-4 text-md py-1 font-medium  ml-3 capitalize"
                key={i}
                href="#"
              >
                {e}
