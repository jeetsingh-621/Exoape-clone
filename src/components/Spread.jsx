...
function Spread() {
  return (
    <div className='w-full sm:h-[100vh] h-[70vh] py-10 bg-white px-4'>
    ...
    <h2>Spread <br /> the News</h2>
        ...
        <div className='w-full text-center flex justify-center'>
            <p className='w-[80%] sm:w-[35%] leading-tight sm:text-[1.6rem] sm:font-[400] text-lg'>Find out more about our work on these leading design and technology platforms.</p>
        </div>
        <div className='w-full flex items-center gap-1 my-10 justify-center'>
            ...
            <h4 className='w-fit border-b-[1px] border-red-900 leading-none sm:text-md '>Browse all news</h4>
        </div>
    </div>
  )
}
